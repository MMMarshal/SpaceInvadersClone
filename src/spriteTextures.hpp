...
/**
 Call once before any sprites are created in order to load the sprite sheet to memory.
*/
...
/**
 ...
 SFML requires that textures to be passed by reference when setting the texture of sprites.
