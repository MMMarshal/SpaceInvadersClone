...
/** The Play class contains all methods for the player/tank including movement,
 * and collision detection. The player sprite is called from the Texture class.
 * **/
...
public:
  ...
  */
  ...
  /**
   Moves the player's tank left or right when 'A' or 'D' is pressed on the
   keyboard.
  */
  void movePlayer();
...
/**
 Generates the players bullet when the spacebar is pressed and adds it to the
 list of bullet projectiles.
...
/**
 ...
 If the player's tank was hit the player loses a life, and the death animation
 occures. If the player has 0 live the game ends.
 @param player -  A Player object.
