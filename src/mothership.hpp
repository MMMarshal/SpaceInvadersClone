...
/**
 ...
 If hit the mothership sprite will change to the destroyed sprite and then
...
/**
 ...
 The mothership will spawn from the right side of the window when it's cooldown
 is complete. The mothership will be deleted if it exists the left side side of
 the window.
...
void mothershipAddRemove(sf::Clock &mothershipClock,
                         const sf::Time &mothershipCooldown, Alien &mothership);
