...
/**
 Represents the barriers on the window. Each barrier contains seven individual
 sprites making up differnt pices of the barrier.
 */
class Barr {
public:
  /**
...
/**
 ...
 @return A list containing three Barr objects in their appropiate location on
 the window.
*/
...
/**
 ...
 If it was hit the struct sprite within the barrier will be removed from the
 Barr object
